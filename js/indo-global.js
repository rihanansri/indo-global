(function ($) {
  ...
  if ($(".mobile-nav__container .main-menu__list").length) {
    let dropdownAnchor = $(
      ".mobile-nav__container .main-menu__list .Products> a"
    );
  ...
  function thmTinyInit() {
    // tiny slider
    const tinyElm = document.querySelectorAll(".agrofa-tiny__slider");
